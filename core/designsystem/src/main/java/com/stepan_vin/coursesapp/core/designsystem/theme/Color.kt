...
object CourseColors {
    ...
    val BlueGradientStart = Color(0xFF2683ED)
    val BlueGradientEnd = Color(0xFF2683ED)
    val OrangeGradientStart = Color(0xFFF98509)
    val OrangeGradientEnd = Color(0xFFF95D00)
}
